...
<body>
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-expand-md"
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center">
        <img class="navbar-brand-logo" src="{{ asset('backend/assets/images/b_logo.png') }}" title="teaching1to1english">
        <span class="navbar-brand-text hidden-xs-down"> teaching1to1english</span>
      </div>
  ...
  <footer class="site-footer">
    <div class="site-footer-legal">© {{ date('Y') }} <a href="javascript:void(0)">teaching1to1english</a></div>
  </footer>
  <!-- Core  -->
