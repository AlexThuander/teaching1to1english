        ...
        <div class="form-group col-md-6">
            ...
            <label class="cabinet center-block">
                <figure class="course-image-container">
                    ...
                    <img src="@if(Storage::exists($course->course_image)){{ Storage::url($course->course_image) }}@else{{ asset('backend/assets/images/female_profile.png') }}@endif" class="gambar img-responsive" id="course_image-output" name="course_image-output" />
                </figure>
            </label>
        </div>
...
<script type="text/javascript">
    ...
    { 
        //image crop start
        $(".gambar").attr("src", @if(Storage::exists($course->course_image))"{{ Storage::url($course->course_image) }}" @else "{{ asset('backend/assets/images/female_profile.png') }}" @endif);
