        ...
        <div class="row mt-4">
            ...
            <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <div class="course-image mt-2">
                        <img src="@if(Storage::exists($course->course_image)){{ Storage::url($course->course_image) }}@else{{ asset('backend/assets/images/female_profile.png') }}@endif">
                    </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 d-none d-md-block">
                ...
                <section class="course_preview_video mt-3">
                    <div class="aligncenter overlay">
                        ...
                        <img src="@if(Storage::exists($file_image_name)){{ Storage::url($file_image_name) }}@else{{ asset('backend/assets/images/female_profile.png') }}@endif" alt="image description">
                    </div>
                </section>
                @endif
